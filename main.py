...
if __name__ == "__main__":
    ...
    (
        ...
        ti3d_model,
        ti3d_model_weights,
    ) = finetune_i3d.finetune_triplet_net(
    ...
    while total_classes < 101:
        ...
        params["model_type"] = "triplet"
        new_train_triplet_features = finetune_i3d.extract_features_triplet_net(
            new_train_features,
            new_train_labels,
            params,
            warm_start_model=ti3d_model_weights,
        )
        new_test_triplet_features = finetune_i3d.extract_features_triplet_net(
            new_test_features,
            new_test_labels,
            params,
            warm_start_model=ti3d_model_weights,
        ...
        full_test_features_ti3d = finetune_i3d.extract_features_triplet_net(
        ...
        full_open_train_labels = [
            x if x in int_known_classes else 0 for x in int_new_train_labels
        ]
        ...
        if params["ti3d_type"] == "incremental":
            ...
            train_features_ti3d_incremental = finetune_i3d.extract_features_triplet_net(
            ...
            full_test_features_ti3d_incremental = (
                finetune_i3d.extract_features_triplet_net(
                    flattened_test_i3d_features,
                    flattened_test_i3d_labels,
                    params,
                    warm_start_model=ti3d_model_incremental_weights,
        ...
        if params["ti3d_type"] == "gold":
            ...
            full_test_features_ti3d_gold = finetune_i3d.extract_features_triplet_net(
                flattened_test_i3d_features,
                flattened_test_i3d_labels,
                params,
        ...
        if params["ti3d_type"] == "fixed":
            full_test_features_ti3d_fixed = finetune_i3d.extract_features_triplet_net(
                flattened_test_i3d_features,
                full_test_labels,
                params,
            ...
            params["model_type"] = "phase_4_fixed_ti3d_gold_evm"
            train_features_ti3d_fixed = finetune_i3d.extract_features_triplet_net(
                flattened_train_i3d_features,
                flattened_train_i3d_labels,
                params,
                warm_start_model=fixed_ti3d_model_weights,
