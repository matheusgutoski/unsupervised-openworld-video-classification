...
def _obtain_input_shape(
    ...
    """
    if (
        weights != "kinetics_only"
        and weights != "imagenet_and_kinetics"
        and input_shape
    ...
    if (
        weights == "kinetics_only" or weights == "imagenet_and_kinetics"
    ) and require_flatten:
        ...
        if data_format == "channels_first":
            if input_shape is not None:
                ...
                if input_shape[1] is not None and input_shape[1] < min_num_frames:
                    raise ValueError(
                        "Input number of frames must be at least "
                        + str(min_num_frames)
                        + "; got "
                        "`input_shape=" + str(input_shape) + "`"
                    )
...
def Inception_Inflated3d(
    ...
    x = conv3d_bn(
        img_input, 64, 7, 7, 7, strides=(2, 2, 2), padding="same", name="Conv3d_1a_7x7"
    )

    # Downsampling (spatial only)
    x = MaxPooling3D(
        (1, 3, 3), strides=(1, 2, 2), padding="same", name="MaxPool2d_2a_3x3"
    )(x)
    x = conv3d_bn(
        x, 64, 1, 1, 1, strides=(1, 1, 1), padding="same", name="Conv3d_2b_1x1"
    )
    x = conv3d_bn(
        x, 192, 3, 3, 3, strides=(1, 1, 1), padding="same", name="Conv3d_2c_3x3"
    )

    # Downsampling (spatial only)
    x = MaxPooling3D(
        (1, 3, 3), strides=(1, 2, 2), padding="same", name="MaxPool2d_3a_3x3"
    )(x)
    ...
    branch_1 = conv3d_bn(
        branch_1, 128, 3, 3, 3, padding="same", name="Conv3d_3b_1b_3x3"
    )

    branch_2 = conv3d_bn(x, 16, 1, 1, 1, padding="same", name="Conv3d_3b_2a_1x1")
    branch_2 = conv3d_bn(branch_2, 32, 3, 3, 3, padding="same", name="Conv3d_3b_2b_3x3")

    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_3b_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(branch_3, 32, 1, 1, 1, padding="same", name="Conv3d_3b_3b_1x1")

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_3b"
    )
    ...
    branch_1 = conv3d_bn(
        branch_1, 192, 3, 3, 3, padding="same", name="Conv3d_3c_1b_3x3"
    )
    ...
    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_3c_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(branch_3, 64, 1, 1, 1, padding="same", name="Conv3d_3c_3b_1x1")

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_3c"
    )

    # Downsampling (spatial and temporal)
    x = MaxPooling3D(
        (3, 3, 3), strides=(2, 2, 2), padding="same", name="MaxPool2d_4a_3x3"
    )(x)
    ...
    branch_1 = conv3d_bn(
        branch_1, 208, 3, 3, 3, padding="same", name="Conv3d_4b_1b_3x3"
    )
    ...
    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_4b_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(branch_3, 64, 1, 1, 1, padding="same", name="Conv3d_4b_3b_1x1")

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_4b"
    )
    ...
    branch_1 = conv3d_bn(
        branch_1, 224, 3, 3, 3, padding="same", name="Conv3d_4c_1b_3x3"
    )
    ...
    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_4c_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(branch_3, 64, 1, 1, 1, padding="same", name="Conv3d_4c_3b_1x1")

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_4c"
    )
    ...
    branch_1 = conv3d_bn(
        branch_1, 256, 3, 3, 3, padding="same", name="Conv3d_4d_1b_3x3"
    )
    ...
    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_4d_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(branch_3, 64, 1, 1, 1, padding="same", name="Conv3d_4d_3b_1x1")

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_4d"
    )
    ...
    branch_1 = conv3d_bn(
        branch_1, 288, 3, 3, 3, padding="same", name="Conv3d_4e_1b_3x3"
    )
    ...
    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_4e_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(branch_3, 64, 1, 1, 1, padding="same", name="Conv3d_4e_3b_1x1")

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_4e"
    )
    ...
    branch_1 = conv3d_bn(
        branch_1, 320, 3, 3, 3, padding="same", name="Conv3d_4f_1b_3x3"
    )

    branch_2 = conv3d_bn(x, 32, 1, 1, 1, padding="same", name="Conv3d_4f_2a_1x1")
    branch_2 = conv3d_bn(
        branch_2, 128, 3, 3, 3, padding="same", name="Conv3d_4f_2b_3x3"
    )

    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_4f_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(
        branch_3, 128, 1, 1, 1, padding="same", name="Conv3d_4f_3b_1x1"
    )

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_4f"
    )

    # Downsampling (spatial and temporal)
    x = MaxPooling3D(
        (2, 2, 2), strides=(2, 2, 2), padding="same", name="MaxPool2d_5a_2x2"
    )(x)
    ...
    branch_1 = conv3d_bn(
        branch_1, 320, 3, 3, 3, padding="same", name="Conv3d_5b_1b_3x3"
    )

    branch_2 = conv3d_bn(x, 32, 1, 1, 1, padding="same", name="Conv3d_5b_2a_1x1")
    branch_2 = conv3d_bn(
        branch_2, 128, 3, 3, 3, padding="same", name="Conv3d_5b_2b_3x3"
    )

    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_5b_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(
        branch_3, 128, 1, 1, 1, padding="same", name="Conv3d_5b_3b_1x1"
    )

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_5b"
    )
    ...
    branch_1 = conv3d_bn(
        branch_1, 384, 3, 3, 3, padding="same", name="Conv3d_5c_1b_3x3"
    )

    branch_2 = conv3d_bn(x, 48, 1, 1, 1, padding="same", name="Conv3d_5c_2a_1x1")
    branch_2 = conv3d_bn(
        branch_2, 128, 3, 3, 3, padding="same", name="Conv3d_5c_2b_3x3"
    )

    branch_3 = MaxPooling3D(
        (3, 3, 3), strides=(1, 1, 1), padding="same", name="MaxPool2d_5c_3a_3x3"
    )(x)
    branch_3 = conv3d_bn(
        branch_3, 128, 1, 1, 1, padding="same", name="Conv3d_5c_3b_1x1"
    )

    x = layers.concatenate(
        [branch_0, branch_1, branch_2, branch_3], axis=channel_axis, name="Mixed_5c"
    )

    if include_top:
        # Classification block
        x = AveragePooling3D(
            (2, 7, 7), strides=(1, 1, 1), padding="valid", name="global_avg_pool"
        )(x)
        ...
        x = Lambda(
            lambda x: K.mean(x, axis=1, keepdims=False),
        ...
        w = int(x.shape[3])
        x = AveragePooling3D(
            (2, h, w), strides=(1, 1, 1), padding="valid", name="global_avg_pool"
        )(x)
