...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="incremental_review_results_hmdb51/",
    )
    parser.add_argument(
        "--ti3d_type",
        help="ti3d type",
    ...
    train, train_labels, test, test_labels = utils.train_test_split_hmdb51(
    ...
    try:
        ...
        train_features, test_features = finetune_i3d_hmdb51.extract_features(
            model_weights,
            initial_train,
            initial_train_labels,
            initial_test,
    ...
    (
        ...
        ti3d_model,
        ti3d_model_weights,
    ) = finetune_i3d_hmdb51.finetune_triplet_net(
        x_train=train_features,
        int_y_train=int_initial_train_labels,
        x_test=test_features,
        params=params,
    )
    train_features_ti3d, test_features_ti3d = np.array(train_features_ti3d), np.array(
        test_features_ti3d
    )
    ...
    evms_triplet, initial_extreme_vectors_i3d, initial_extreme_vectors_labels = evm.fit(
        train_features_ti3d, int_initial_train_labels, params, train_features
    )
    ...
    openness = utils.openness(
        params["n_train_classes"], params["n_test_classes"], params["n_train_classes"]
    )
    params["openness"] = 0
    ...
    evaluation.single_evaluation_clustering(
        test_features_ti3d, open_y_test, pred, params
    )

    dict = {}
    dict["x"] = test_features_ti3d.copy()
    ...
    while total_classes < 51:
        ...
        new_n_classes = params["incremental_n_classes"]
        ...
        # this is wrong. Need to compare to all knowns so far
        ...
        try:
            ...
            print(e)
            params["model_type"] = "cnn"
            new_train_features = finetune_i3d_hmdb51.extract_features_single(
                model_weights,
                new_train,
                new_train_labels,
                dict_map_new_train,
            ...
            new_test_features = finetune_i3d_hmdb51.extract_features_single(
                model_weights,
                new_test,
                new_test_labels,
                dict_map_new_test,
        ...
        params["model_type"] = "triplet"
        new_train_triplet_features = finetune_i3d_hmdb51.extract_features_triplet_net(
            new_train_features,
            new_train_labels,
            params,
            warm_start_model=ti3d_model_weights,
        )
        new_test_triplet_features = finetune_i3d_hmdb51.extract_features_triplet_net(
            new_test_features,
            new_test_labels,
            params,
            warm_start_model=ti3d_model_weights,
        ...
        full_test_features_ti3d = finetune_i3d_hmdb51.extract_features_triplet_net(
            flattened_test_i3d_features,
            flattened_test_i3d_labels,
            params,
            warm_start_model=ti3d_model_weights,
        )
        ...
        estimated_k, gaps = k_estimator.estimate_dendrogap(
            rejected_set_features_ti3d, top_k, normalize_data=True
        )
        estimated_k = k_estimator.best_silhouette(
            rejected_set_features_ti3d, estimated_k, metric="cosine"
        )
        ...
        evaluation.single_evaluation_clustering(
            rejected_set_features_ti3d, rejected_set_labels, hierarchical_preds, params
        )
        ...
        if params["iteration"] == 1:
            extreme_vectors_features_i3d, extreme_vectors_labels = np.array(
                initial_extreme_vectors_i3d
            ), np.array(initial_extreme_vectors_labels)
        ...
        # estimate extreme vectors of new data using a new evm

        if params["estimate_new_data_evs"]:
            print("estimating evs for new data")
            (
                ___,
                estimated_extreme_vectors_i3d,
                estimated_extreme_vectors_labels,
            ) = evm.fit(
                rejected_set_features_ti3d,
                rejected_set_labels,
                params,
            ...
            rejected_set_features_i3d = estimated_extreme_vectors_i3d
        ...
        ti3d_finetune_set = np.concatenate(
            (extreme_vectors_features_i3d, rejected_set_features_i3d)
        )
        ti3d_finetune_labels = np.concatenate(
            (extreme_vectors_labels, hierarchical_preds)
        )
        (
            train_features_ti3d_incremental,
            test_features_ti3d_incremental,
            hist_triplet,
            ti3d_model_incremental,
            ti3d_model_incremental_weights,
        ) = finetune_i3d_hmdb51.finetune_triplet_net(
            x_train=ti3d_finetune_set,
            int_y_train=ti3d_finetune_labels,
            x_test=test_features,
            params=params,
            warm_start_model=ti3d_model_weights,
        )
        ...
        extreme_vectors_features_ti3d_incremental = train_features_ti3d_incremental[
            0 : extreme_vectors_features_i3d.shape[0]
        ]
        # this is the new data ti3d incremental representation
        new_train_features_ti3d_incremental = train_features_ti3d_incremental[
            extreme_vectors_features_i3d.shape[0] :
        ]
        ...
        if params["incremental_evm"]:
            (
                updated_evms,
                new_extreme_vectors_i3d,
                new_extreme_vectors_labels,
            ) = evm.increment_evm(
                extreme_vectors_features_ti3d_incremental,
                extreme_vectors_labels,
                new_train_features_ti3d_incremental,
                hierarchical_preds,
                params,
                new_train_features,
            )
            ...
            extreme_vectors_features_i3d, extreme_vectors_labels = np.concatenate(
                (extreme_vectors_features_i3d, new_extreme_vectors_i3d)
            ), np.concatenate((extreme_vectors_labels, new_extreme_vectors_labels))
        ...
        if params["ti3d_type"] == "incremental":
            if params["incremental_evm"]:
                if params["online"]:
                    ...
                    params[
                        "model_type"
                    ] = "phase_4_incremental_ti3d_incremental_evm_tail_" + str(
                        params["tail_size"]
                    )
                ...
                if params["online"]:
                    params["model_type"] = (
                        "phase_4_incremental_ti3d_gold_evm_tail_"
                        + str(params["tail_size"])
                        + "_online"
                    )
                else:
                    params[
                        "model_type"
                    ] = "phase_4_incremental_ti3d_gold_evm_tail_" + str(
                        params["tail_size"]
                    )

            train_features_ti3d_incremental = (
                finetune_i3d_hmdb51.extract_features_triplet_net(
                    flattened_train_i3d_features,
                    flattened_train_i3d_labels,
                    params,
                    warm_start_model=ti3d_model_incremental_weights,
                )
            )
            full_test_features_ti3d_incremental = (
                finetune_i3d_hmdb51.extract_features_triplet_net(
                    flattened_test_i3d_features,
                    flattened_test_i3d_labels,
                    params,
            ...
            print(
                train_features_ti3d_incremental.shape,
                len(flattened_train_i3d_labels),
            ...
            if params["incremental_evm"]:
                ...
                preds = evm.predict(
                    updated_evms, full_test_features_ti3d_incremental, params
                )
                ...
                preds = evm.predict(
                    gold_evms, full_test_features_ti3d_incremental, params
                )
                print("incremental ti3d gold evm")
                utils.save_evm_models(gold_evms, params, save_params=False)

            evaluation.single_evaluation_clustering(
                full_test_features_ti3d_incremental, full_test_labels, preds, params
            )
            ...
            forgetting, full_evaluation = evaluation.full_evaluation(
                all_results, params
            )

            utils.save_full_report(forgetting, full_evaluation, params)
            utils.save_ti3d_features(
                train_features_ti3d_incremental,
                full_test_features_ti3d_incremental,
                flattened_train_i3d_labels,
                full_test_labels,
            ...
            utils.save_ti3d_model(
                ti3d_model_incremental, ti3d_model_incremental_weights, params
            )
        ...
        if params["ti3d_type"] == "gold":
            if params["online"]:
                ...
                params["model_type"] = "phase_4_gold_ti3d_gold_evm"
            (
                train_features_ti3d_gold,
                _,
                hist_triplet,
                ti3d_model_gold,
                ti3d_model_gold_weights,
            ) = finetune_i3d_hmdb51.finetune_triplet_net(
                x_train=flattened_train_i3d_features,
                int_y_train=flattened_train_i3d_labels,
                x_test=flattened_test_i3d_features,
                params=params,
                warm_start_model=None,
            )
            full_test_features_ti3d_gold = (
                finetune_i3d_hmdb51.extract_features_triplet_net(
                    flattened_test_i3d_features,
                    flattened_test_i3d_labels,
                    params,
                    warm_start_model=ti3d_model_gold_weights,
                )
            )
            gold_evms = evm.fit(
                train_features_ti3d_gold, flattened_train_i3d_labels, params
            )

            preds = evm.predict(gold_evms, full_test_features_ti3d_gold, params)
            print("gold ti3d gold evm")
            evaluation.single_evaluation_clustering(
                full_test_features_ti3d_gold, full_test_labels, preds, params
            )
        ...
        if params["ti3d_type"] == "fixed":
            full_test_features_ti3d_fixed = (
                finetune_i3d_hmdb51.extract_features_triplet_net(
                    flattened_test_i3d_features,
                    full_test_labels,
                    params,
                    warm_start_model=fixed_ti3d_model_weights,
                )
            )
            params["model_type"] = "phase_4_fixed_ti3d_gold_evm"
            train_features_ti3d_fixed = (
                finetune_i3d_hmdb51.extract_features_triplet_net(
                    flattened_train_i3d_features,
                    flattened_train_i3d_labels,
                    params,
            ...
            gold_evms = evm.fit(
                train_features_ti3d_fixed, flattened_train_i3d_labels, params
            )
            preds = evm.predict(gold_evms, full_test_features_ti3d_fixed, params)
            print("fixed ti3d gold evm")
            evaluation.single_evaluation_clustering(
                full_test_features_ti3d_fixed, full_test_labels, preds, params
            )
